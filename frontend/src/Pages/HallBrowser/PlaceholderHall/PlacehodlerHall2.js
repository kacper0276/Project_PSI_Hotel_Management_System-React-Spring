...
export default function PlaceholderHall2() {
  return (
      ...
      <div className="room-item">
        ...
        <div className="room-text mt-3">
          <div className="room-title ">
            ...
            <div className="room-price d-flex align-items-end price">
              <h2 className="basic-text mb-0">10 000zł/wieczór</h2>
            </div>
          </div>
          <div className="room-features d-flex justify-content-around align-items-center flex-wrap">
